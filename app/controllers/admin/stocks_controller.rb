class Admin::StocksController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_stock.save
        format.html { redirect_to admin_product_stock_path(@product, @admin_stock), notice: "Stock was successfully created." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_product_stocks_path(@admin_stock.product, @admin_stock), status: :see_other, notice: "Stock was successfully destroyed." }
